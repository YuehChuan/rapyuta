...
#include "rapyuta_pose_estimator_lib/led_detector.h"
#include "rapyuta_pose_estimator_lib/visualization.h"
#include "rapyuta_pose_estimator_lib/combinations.h"
#include "rapyuta_pose_estimator_lib/p3p.h"
#include <iostream>
